...
import { getTasks, TaskWithUser } from "@/actions/get-tasks"
...
const TaskPage = () => {
  const [taskList, setTaskList] = useState<TaskWithUser[]>([])
      ...
      <Card className="w-lg">
        ...
        <CardContent>
          ...
          <div className="mt-4 border-t border-b divide-y">
            {/* Cabeçalho do grid */}
            <div className="h-10 flex items-center bg-muted/40">
